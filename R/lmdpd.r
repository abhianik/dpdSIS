#' MDPDE for Linear Regression Model
#'
#' Computes the robust Minimum Density Power Divergence Estimator (MDPDE) under a Linear Regression Model  y=X*beta + e, with e ~ N(0, sigma^2) for unknown sigma.
#'
